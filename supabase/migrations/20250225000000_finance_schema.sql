...
CREATE POLICY "Allow admin and manager access to service contracts"
...
CREATE POLICY "Allow admin and manager access to contract payments"
...
CREATE POLICY "Allow admin and manager access to staff payouts"
    ON staff_payouts
    FOR ALL TO authenticated
    USING (
        EXISTS (
