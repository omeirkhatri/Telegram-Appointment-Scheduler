...
function StaffSearchForm({ onSearch, onReset, isLoading }: StaffSearchFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setFilters(prev => ({ ...prev, staff_type: e.target.value as any }))}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <select
            value={filters.available_on_day || ''}
            onChange={(e) => setFilters(prev => ({ ...prev, available_on_day: Number(e.target.value) }))}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
...
export function StaffSearch({ onStaffSelect, showFilters = true, className = '' }: StaffSearchProps) {
  ...
  const handleFilterChange = (filters: StaffFilters) => {
                  ...
                  >
                      ...
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          {staffMember.specialization && (
                            <div className="text-sm text-gray-500">{staffMember.specialization}</div>
                          )}
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="space-y-1">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStaffTypeColor(staffMember.staff_type)}`}>
