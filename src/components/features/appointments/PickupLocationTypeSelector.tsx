...
const PICKUP_LOCATION_TYPES: Array<{
...
}> = [
  {
    value: 'office',
    label: 'From Office',
    description: 'Pick up from the main office location',
    icon: Building2,
    color: 'text-blue-600',
  },
  {
    ...
    description: 'Pick up from a previous patient appointment location',
    icon: User,
  ...
  },
  {
    ...
    description: 'Pick up from a metro/subway station',
    icon: Navigation,
  ...
  },
  {
    ...
    description: 'Pick up from a custom address or location',
    icon: MapPin,
