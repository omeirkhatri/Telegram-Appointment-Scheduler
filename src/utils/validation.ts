...
export function safeValidatePatient(
  data: unknown,
):
  | { success: true; data: PatientFormData }
...
export function safeValidateStaff(
  data: unknown,
):
  | { success: true; data: StaffFormData }
  | { success: false; errors: z.ZodError } {
...
export function safeValidateAppointment(
  data: unknown,
):
  | { success: true; data: AppointmentFormData }
  | { success: false; errors: z.ZodError } {
